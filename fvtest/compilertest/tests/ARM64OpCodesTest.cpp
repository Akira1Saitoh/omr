...
TEST_P(ARM64Int32BitwiseOpCodesTest, iAnd)
   ...
   //verify that andimmw is correctly encoded
...
TEST_P(ARM64Int32BitwiseOpCodesTest, iOr)
   ...
   //verify that orimmw is correctly encoded
...
TEST_P(ARM64Int32BitwiseOpCodesTest, iXor)
   ...
   //verify that eorimmw is correctly encoded
...
INSTANTIATE_TEST_CASE_P(ARM64Int32BitwiseImmediateEncodeTest, ARM64Int32BitwiseOpCodesTest,
   ::testing::ValuesIn(int32BitwiseEncodableImmediates));

INSTANTIATE_TEST_CASE_P(ARM64Int32BitwiseImmediateUnencodedTest, ARM64Int32BitwiseOpCodesTest,
...
TEST_P(ARM64Int64BitwiseOpCodesTest, lAnd)
   ...
   //verify that andimmx is correctly encoded
...
TEST_P(ARM64Int64BitwiseOpCodesTest, lOr)
   ...
   //verify that orimmx is correctly encoded
...
TEST_P(ARM64Int64BitwiseOpCodesTest, lXor)
   ...
   //verify that eorimmx is correctly encoded
...
INSTANTIATE_TEST_CASE_P(ARM64Int64BitwiseImmediateEncodeTest, ARM64Int64BitwiseOpCodesTest,
   ::testing::ValuesIn(int64BitwiseEncodableImmediates));

INSTANTIATE_TEST_CASE_P(ARM64Int64BitwiseImmediateUnencodedTest, ARM64Int64BitwiseOpCodesTest,
